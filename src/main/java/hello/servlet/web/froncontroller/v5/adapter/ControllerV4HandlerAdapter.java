...
public class ControllerV4HandlerAdapter implements MyHandlerAdapter {
    ...
    @Override
    public ModelView handle(HttpServletRequest request, HttpServletResponse response, Object hadler) throws ServletException, IOException {
        ControllerV4 controller = (ControllerV4) hadler;
